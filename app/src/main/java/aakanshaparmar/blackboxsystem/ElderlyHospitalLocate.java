...
public class ElderlyHospitalLocate extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener,  GoogleApiClient.ConnectionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elderly_hospital_locate);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_elderly_hospital_locate, menu);
        return true;
    }
    ...
    protected void findNearbyPlaces() {
    ...
    protected void createURL()
    {
        ...
        sb.append("location="+origin.latitude+","+origin.longitude);
        sb.append("&radius=1000");
        sb.append("&types=hospital");
        sb.append("&sensor=true&rankBy=distance");
        sb.append("&key=AIzaSyC4hMHujEFrdCGMqI50lUe8a18LPOeha3A");
        ...
        protected void onPostExecute(List<HashMap<String,String>> list){
            ...
            for(int i=0;i<list.size();i++){
                ...
                if(i==0 && list.size()>0)
                {
                    ...
                    String DirectionRequestUrl = getDirectionsUrl(origin, latLng);
