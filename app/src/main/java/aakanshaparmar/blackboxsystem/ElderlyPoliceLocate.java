...
public class ElderlyPoliceLocate extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener,  GoogleApiClient.ConnectionCallbacks {
    ...
    protected void createURL()
    {
        ...
        sb.append("&key=AIzaSyC4hMHujEFrdCGMqI50lUe8a18LPOeha3A&rankBy=distance");
